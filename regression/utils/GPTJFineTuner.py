...
import numpy as np
sys.path.insert(1, '/home/ubuntu/nocode-ml')
...
class GPTJFineTuner(object):
    ...
    def eval(self,n_train,valid_prompts,valid_df,test_prompts,test_df,y_name='y',plot=False,X_grid=None,grid_prompts=None,y_grid=None,file_name=None, train_df = None):
        """
